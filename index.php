    ...
    <div class="container">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                ...
                <a href="pages/create-listing.php" class="btn btn-secondary">Sell Your Books</a>
            </div>
        </div>
...
<section class="recent-listings">
    <div class="container">
                ...
                <?php foreach ($listings as $listing): ?>
                    <div class="listing-card">
                        ...
                        <div class="listing-details">
                            ...
                            <a href="pages/view-listing.php?id=<?php echo $listing['id']; ?>" class="btn btn-small">View Details</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
        ...
        <div class="view-all">
            <a href="pages/listings.php" class="btn btn-primary">View All Listings</a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="cta-buttons">
            <?php if (isset($_SESSION['user_id'])): ?>
                <a href="pages/create-listing.php" class="btn btn-large btn-primary">List Your Books</a>
            <?php else: ?>
                <a href="pages/register.php" class="btn btn-large btn-primary">Create Account</a>
            <?php endif; ?>
            <a href="pages/listings.php" class="btn btn-large btn-secondary">Browse Textbooks</a>
        </div>
    </div>
</section>
