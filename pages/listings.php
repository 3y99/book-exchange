...
$min_price = isset($_GET['min_price']) ? floatval($_GET['min_price']) : 0; // Fixed: was using max_price for min_price
...
// Build the SQL query - REMOVED status filter to show all listings
$sql = "
    SELECT l.*, b.title, b.author, b.isbn, b.course_code, 
           u.username, u.university, u.rating as seller_rating,
...
// Add rating filter
if (!empty($min_rating) && $min_rating > 0) {
    $sql .= " AND u.rating >= ?";
    $params[] = $min_rating;
}

// Price range filter - only apply if values are valid
            ...
            <div class="listings-sidebar">
                <div class="filter-card">
                    ...
                    <form method="GET" action="">
                        ...
                        <div class="form-group">
                            <label for="min_rating" class="form-label">Minimum Seller Rating</label>
                            <select id="min_rating" name="min_rating" class="form-select">
                                ...
                                <option value="3.5" <?php echo $min_rating == 3.5 ? 'selected' : ''; ?>>3.5+ Stars</option>
                                <option value="3.0" <?php echo $min_rating == 3.0 ? 'selected' : ''; ?>>3.0+ Stars</option>
                            </select>
                        </div>
