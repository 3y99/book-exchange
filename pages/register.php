<?php
$pageTitle = "Register";  //Set title（Register）
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {     //When the user clicks the "register" button to submit
    $username = sanitize($_POST['username']);    //Read the input
    ...
    if (empty($first_name)) {            //Fname
        $errors[] = "First name is required.";
    }
    
    if (empty($last_name)) {             //Lname
